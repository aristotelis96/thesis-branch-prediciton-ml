...
print(model)
## TRAIN/TEST DATALOADERmodel = RNNLayer(input_dim=2, out_dim=n_class, num_layers=1).to(device)
...
train = read.read("../../Datasets/600.perlbench_s-210B.champsimtrace.xz._.dataset_unique.txt.gz", 100, 101)
print("Loading ValidationDataset")
#valid = torch.load("valid100K.pt")
valid = read.read("../../Datasets/600.perlbench_s-210B.champsimtrace.xz._.dataset_unique.txt.gz", 100, 100000)
